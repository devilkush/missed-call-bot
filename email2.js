...
function buildDay3CheckinEmail(plumber) {
  ...
  var body =
    ...
    infoBox(ORANGE, "iPhone - Set up call forwarding",
      "1. Open Settings<br/>" +
      "2. Tap Phone<br/>" +
      "3. Tap Call Forwarding<br/>" +
      "4. Toggle ON<br/>" +
      "5. Enter: <b>+1 888 576 0762</b>"
    ) +
    infoBox("#0b1928", "Android - Set up call forwarding",
      "1. Open the Phone app<br/>" +
      "2. Tap the three dots (menu)<br/>" +
      "3. Tap Settings then Call Forwarding<br/>" +
      "4. Tap When Unanswered<br/>" +
      "5. Enter: <b>+1 888 576 0762</b>"
    ) +
    "</td></tr></table>" +
    divider() +
