...
const BRAND = {
  ...
  textMuted:  "#6b84a0",
  white:      "#ffffff",
  logoUrl:    "https://zeromisscall.com/zeromisscall.png",
          ...
          <tr>
            <td style="background:#0f2035;border-radius:0 0 12px 12px;padding:24px 36px;text-align:center;border-top:1px solid #1a3550;">
              ...
              <p style="font-family:'DM Sans',Arial,sans-serif;font-size:12px;color:#4a6278;margin:0;">
                ...
                To update your preferences, <a href="${BRAND.siteUrl}/contact" style="color:#6b84a0;text-decoration:underline;">contact us</a>.
              </p>
            </td>
          </tr>
...
function buildTrialEndEmail(plumber, stats, conversations) {
  ...
  const content = `
    ...
    <div style="padding:0 36px 36px;text-align:center;">
      ...
      <a href="${BRAND.upgradeUrl}" class="cta-button" style="display:inline-block;background:#E8791A;color:#ffffff;font-family:'Nunito',Arial,sans-serif;font-size:16px;font-weight:700;padding:16px 40px;border-radius:8px;text-decoration:none;">
  ...
  const content = `
    ...
    <div style="padding:0 36px 36px;">
      ...
      <p style="font-family:'DM Sans',Arial,sans-serif;font-size:13px;color:#6b84a0;margin-top:16px;line-height:1.6;">
        ...
        <a href="${BRAND.siteUrl}/contact" style="color:#E8791A;">zeromisscall.com/contact</a>
      </p>
    </div>
  `;
